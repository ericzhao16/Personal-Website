    ...
    <div id='home' className='w-full h-screen text-center'>
        <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
            <div>
                ...
                <div className='mt-5 w-auto rounded-full shadow-lg shadow-gray-400 p-3 max-w-[20%] cursor-pointer hover:scale-105 ease-in duration-300 items-center mx-auto'>
