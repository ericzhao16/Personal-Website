    ...
    <div id='experience' className='w-full lg:h-screen p-2'>
        <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
            ...
            <div className='grid md:grid-cols-2 gap-8'>
                <ExperienceItem companyTitle={snapImg} jobTitle='Software Engineer Intern' dates='May 2024 - Aug 2024' description='Working on post-capture search in Lens Explorer so you can now search for and add filters, even after you have taken a snap.'/>
